<?php
/**
 * ZHIMA API: zhima.credit.antifraud.inner.query request
 *
 * @author auto create
 * @since 1.0, 2017-03-22 17:42:25
 */
class ZhimaCreditAntifraudInnerQueryRequest
{
	/** 
	...
	public function setFraudProd($fraudProd)
	{
		$this->fraudProd = $fraudProd;
		$this->apiParas["fraud_prod"] = $fraudProd;
	}

	public function getFraudProd()
	{
		return $this->fraudProd;
	}
	...
	{
		return "zhima.credit.antifraud.inner.query";
	}
